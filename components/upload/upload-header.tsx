  ...
  return (
    <div className="flex flex-col items-center justify-center gap-6 text-center">
      ...
      >
        <Badge
          variant={"secondary"}
          className="relative px-6 py-2 text-base font-medium bg-white rounded-full group-hover:bg-rose-300 transition-colors"
        >
      ...
      <MotionDiv variants={itemVariants}>
        <h1 className="capitalize text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl mb-2">
          Start Uploading!
        </h1>

        {/* Highlighted text with background */}
        <span className="relative inline-block">
          <span className="relative z-10 px-2 capitalize text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            Your PDF’s
          </span>
          <span
